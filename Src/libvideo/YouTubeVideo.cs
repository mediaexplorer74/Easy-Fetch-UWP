...
namespace VideoLibrary
{
  public class YouTubeVideo : Video
  {
    ...
    public string GetUri(Func<DelegatingClient> makeClient) => this.GetUriAsync(makeClient).GetAwaiter().GetResult();

    public override Task<string> GetUriAsync() => this.GetUriAsync((Func<DelegatingClient>) (() => new DelegatingClient()));
    ...
    private class Decryptor
    {
      ...
      public bool IsComplete => this._functionTypes.Count == Enum.GetValues(typeof (YouTubeVideo.Decryptor.FunctionType)).Length;
