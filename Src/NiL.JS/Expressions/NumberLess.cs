...
// Type: NiL.JS.Expressions.NumberLess
  ...
  public sealed class NumberLess : Expression
  {
    ...
    public override JSValue Evaluate(Context context)
    {
      ...
      if (jsValue._valueType == JSValueType.Integer)
      {
        ...
        return (JSValue) Less.Check(this._tempContainer, second);
      }
      ...
      int num = Less.Check(tempContainer, this._right.Evaluate(context)) ? 1 : 0;
