...
// Type: NiL.JS.Expressions.NumberLessOrEqual
  ...
  public sealed class NumberLessOrEqual : Expression
  {
    ...
    public override JSValue Evaluate(Context context)
    {
      ...
      if (jsValue._valueType == JSValueType.Integer || jsValue._valueType == JSValueType.Boolean)
      {
        ...
        return (JSValue) !More.Check(this._tempContainer, second, true);
      }
      ...
      int num = !More.Check(tempContainer, this._right.Evaluate(context), true) ? 1 : 0;
