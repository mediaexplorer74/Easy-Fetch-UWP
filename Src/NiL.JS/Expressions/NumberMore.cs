...
// Type: NiL.JS.Expressions.NumberMore
  ...
  public sealed class NumberMore : Expression
  {
    ...
    public override JSValue Evaluate(Context context)
    {
      ...
      if (jsValue._valueType == JSValueType.Integer || jsValue._valueType == JSValueType.Boolean)
      {
        ...
        return (JSValue) More.Check(this._tempContainer, second, false);
      }
      ...
      int num = More.Check(tempContainer, this._right.Evaluate(context), false) ? 1 : 0;
