...
// Type: NiL.JS.Expressions.LogicalConjunction
...
namespace NiL.JS.Expressions
{
  public sealed class LogicalConjunction : Expression
  {
    ...
    public override JSValue Evaluate(Context context)
    {
      ...
      return !(bool) jsValue ? jsValue : this._right.Evaluate(context);
    }
      ...
      Options opts)
    {
      if (message != null && expressionDepth <= 1)
        message(MessageLevel.Warning, this.Position, 0, "Do not use a logical operator as a conditional statement");
