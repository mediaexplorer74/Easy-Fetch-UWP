...
namespace NiL.JS.Expressions
{
  public class More : Expression
  {
    ...
    {
      this.trueMore = (object) this.GetType() == (object) typeof (More);
    }
      ...
      switch (first._valueType)
      {
        ...
        case JSValueType.Integer:
          switch (second._valueType)
          {
            ...
            case JSValueType.Double:
              return double.IsNaN(second._dValue) ? lessOrEqual : (double) first._iValue > second._dValue;
            case JSValueType.String:
              int index1 = 0;
              double num1 = 0.0;
              return Tools.ParseNumber(second._oValue.ToString(), ref index1, out num1) && index1 == second._oValue.ToString().Length ? (double) first._iValue > num1 : lessOrEqual;
        ...
        case JSValueType.Double:
          ...
          switch (second._valueType)
          {
            ...
            case JSValueType.Double:
              return double.IsNaN(first._dValue) || double.IsNaN(second._dValue) ? lessOrEqual : first._dValue > second._dValue;
            case JSValueType.String:
              int index2 = 0;
              double num2 = 0.0;
              return Tools.ParseNumber(second._oValue.ToString(), ref index2, out num2) && index2 == second._oValue.ToString().Length ? first._dValue > num2 : lessOrEqual;
            case JSValueType.Object:
            case JSValueType.Date:
              second = second.ToPrimitiveValue_Value_String();
              if (second._valueType != JSValueType.Integer && second._valueType != JSValueType.Boolean)
        ...
        case JSValueType.String:
          ...
          switch (second._valueType)
          {
            ...
            case JSValueType.Integer:
              double num3 = 0.0;
              int index3 = 0;
              return Tools.ParseNumber(str, ref index3, out num3) && index3 == str.Length ? num3 > (double) second._iValue : lessOrEqual;
            case JSValueType.Double:
              double num4 = 0.0;
              int index4 = 0;
              return Tools.ParseNumber(str, ref index4, out num4) && index4 == str.Length ? num4 > second._dValue : lessOrEqual;
            case JSValueType.String:
            ...
            case JSValueType.Function:
              ...
              switch (second._valueType)
              {
                ...
                case JSValueType.Object:
                  double num7 = 0.0;
                  int index7 = 0;
                  return Tools.ParseNumber(str, ref index7, out num7) && index7 == str.Length ? num7 > 0.0 : lessOrEqual;
                default:
                  throw new NotImplementedException();
              }
            default:
    ...
    public override JSValue Evaluate(Context context)
    {
      ...
      if (this._tempContainer._valueType == JSValueType.Integer && second._valueType == JSValueType.Integer)
      {
        this._tempContainer._valueType = JSValueType.Boolean;
        this._tempContainer._iValue = this._tempContainer._iValue > second._iValue ? 1 : 0;
        return this._tempContainer;
      }
      if (this._tempContainer._valueType != JSValueType.Double || second._valueType != JSValueType.Double)
        return (JSValue) More.Check(this._tempContainer, second, !this.trueMore);
      jsValue2._valueType = JSValueType.Boolean;
      jsValue2._iValue = double.IsNaN(jsValue2._dValue) || double.IsNaN(second._dValue) ? (this.trueMore ? 0 : 1) : (jsValue2._dValue > second._dValue ? 1 : 0);
      return this._tempContainer;
    }
      ...
      FunctionInfo stats)
    {
      ...
      if (_this != this || this._left.ResultType != PredictedType.Number || this._right.ResultType != PredictedType.Number)
        return;
      _this = (CodeNode) new NumberMore(this._left, this._right);
    }
