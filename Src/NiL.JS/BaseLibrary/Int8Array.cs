...
// Type: NiL.JS.BaseLibrary.Int8Array
...
namespace NiL.JS.BaseLibrary
{
  public sealed class Int8Array : TypedArray
  {
    ...
    private sbyte getValue(int index) => (sbyte) this.buffer.data[index + this.byteOffset];
    ...
    [ArgumentsCount(2)]
    public override TypedArray subarray(Arguments args) => (TypedArray) this.subarrayImpl<Int8Array>(args[0], args[1]);
    ...
    {
      sbyte[] nativeArray = new sbyte[this.length._iValue];
