...
// Type: NiL.JS.BaseLibrary.Uint8ClampedArray
  ...
  public sealed class Uint8ClampedArray : TypedArray
  {
    protected override JSValue this[int index]
    {
      ...
      set
      {
        ...
        this.buffer.data[index + this.byteOffset] = (byte) System.Math.Min((int) byte.MaxValue, System.Math.Max(0, Tools.JSObjectToInt32(value, 0, false)));
      }
    }
    ...
    [ArgumentsCount(2)]
    public override TypedArray subarray(Arguments args) => (TypedArray) this.subarrayImpl<Uint8ClampedArray>(args[0], args[1]);
