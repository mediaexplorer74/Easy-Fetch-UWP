...
namespace StoreLib.Services
{
    public class DisplayCatalogHandler
    {
        ...
        {
            string xml = await FE3Handler.SyncUpdatesAsync(ProductListing.Product.DisplaySkuAvailabilities[0].Sku.Properties.FulfillmentData.WuCategoryId, new System.Threading.CancellationToken());
            IList<string> RevisionIDs;
            IList<PackageItem> Packages;
